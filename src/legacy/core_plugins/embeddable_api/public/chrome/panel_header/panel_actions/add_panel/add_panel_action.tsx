...
export class AddPanelAction extends Action {
  ...
  public isCompatible({ embeddable, container }: { embeddable: Container; container?: Container }) {
    return Promise.resolve(embeddable.isContainer && embeddable.getViewMode() === ViewMode.EDIT);
  }
